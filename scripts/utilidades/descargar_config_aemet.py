...
class DescargadorAEMET:
    ...
    def __init__(self):
        self.env_file = '.env'
        self.url_drive = "https://drive.google.com/uc?id=1buceaEXByOO228JyVDkWwTrf7sqgaJoN"
        load_dotenv()
    ...
    def extraer_api_key_desde_archivo(self, ruta_archivo):
        ...
        try:
            ...
            if api_key_encontrada:
                ...
                logging.info(f"🔑 API Key: {api_key_encontrada[:20]}...{api_key_encontrada[-10:]}")
...
def configuracion_automatica():
    ...
    if descargador.ejecutar_descarga_configuracion():
        ...
        print("2. Configurar manualmente con: python -m scripts.utilidades.configurador_aemet")
