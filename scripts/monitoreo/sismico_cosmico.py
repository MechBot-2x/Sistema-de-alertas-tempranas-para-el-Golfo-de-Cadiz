...
class SismicMonitorCosmico:
            ...
            if response.status_code == 200:
                ...
                for feature in datos['features'][:20]:
                    ...
                    sismo = {
                        ...
                        'fuente': 'USGS',
                        'energia_telurica': self._calcular_energia_telurica(prop['mag'], geo['coordinates'][2])
                    }
                    sismos.append(sismo)
    ...
    def _clasificar_energia(self, energia):
        ...
        if energia > 5.0: return 'ALTA_COSMICA'
        if energia > 2.0: return 'MEDIA_COSMICA'
        return 'BAJA_COSMICA'
    ...
    def buscar_sismos_golfo_cadiz_cosmicos(self, dias=3):
        ...
        try:
            ...
            logging.info(f"🌊 Encontrados {len(sismos_golfo)} sismos cósmicos en Golfo de Cádiz")
            return sismos_golfo
